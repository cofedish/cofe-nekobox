#text="$(curl -s -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/cofedish/cofe-nekobox/releases/tags/"$INPUT_VERSION")"
...
url_x64="https://github.com/cofedish/cofe-nekobox/releases/download/${INPUT_VERSION}/nekobox-${INPUT_VERSION}-windows64-installer.exe"
#sha_x86="$(echo "$asset_x86" | jq -r '.digest' | sed 's~sha256:~~g')"
#sha_x64="$(echo "$asset_x64" | jq -r '.digest' | sed 's~sha256:~~g')"


# 'https://github.com/cofedish/cofe-nekobox/releases/download/@VERSION@/nekobox-@VERSION@-windows32-installer.exe'
# 'https://github.com/cofedish/cofe-nekobox/releases/download/@VERSION@/nekobox-@VERSION@-windows64-installer.exe'
