# [NekoBox](https://github.com/cofedish/cofe-nekobox) for PC 
...
### GitHub Releases (Portable ZIPs, Windows installers, [AppImages](https://github.com/cofedish/cofe-nekobox/discussions/41))

[![GitHub All Releases](https://img.shields.io/github/downloads/cofedish/cofe-nekobox/total?label=downloads-total&logo=github)](https://github.com/cofedish/cofe-nekobox/releases)
...
**I have computer with Windows 7, or Window 8, or Windows 8.1. Which version of [NekoBox](https://github.com/cofedish/cofe-nekobox) should I download?** <br/>
For Windows 7, Windows 8 and Windows 8.1 it is recommended to install 32 bit [NekoBox](https://github.com/cofedish/cofe-nekobox), even if you run Windows with x64 cpu support. In generally, 64 bit executables does not means run faster than 32 bit unless program needs more than 2Gb of ram memory, which is not the case with [NekoBox](https://github.com/cofedish/cofe-nekobox). 64 bit executables are built with latest Qt and does support Windows 10/11 dark theme. You can read more about 32 bit software at [Reddit topic](https://www.reddit.com/r/AskComputerScience/comments/15aqv4o/are_there_any_advantages_to_32_bit_software_or_64/)
...
**Does [NekoBox](https://github.com/cofedish/cofe-nekobox) really need to be run in UAC mode on Windows?** <br/>
No, that is not necessary. [NekoBox](https://github.com/cofedish/cofe-nekobox) restarts nekobox_core in UAC mode if TUN mode is selected and [NekoBox](https://github.com/cofedish/cofe-nekobox) is not already running with administrator privileges. [NekoBox](https://github.com/cofedish/cofe-nekobox) requests UAC confirmation to restart the core.

**Is setting the `SUID` bit really needed on Linux?** <br/>
No, it is not needed, but if `SUID` does not configured properly, the [NekoBox](https://github.com/cofedish/cofe-nekobox) will ask for administrator password to order to restart nekobox_core with administrator privilegies, if TUN mode is selected and [NekoBox](https://github.com/cofedish/cofe-nekobox) is not already running as root (or with special capabilities), [NekoBox](https://github.com/cofedish/cofe-nekobox) will ask for password for once, and will not configure `SUID`.

**Why does my internet stop working after I force quit [NekoBox](https://github.com/cofedish/cofe-nekobox)?** <br/>
If [NekoBox](https://github.com/cofedish/cofe-nekobox) is force-quit while `System proxy` is enabled, the process ends immediately and [NekoBox](https://github.com/cofedish/cofe-nekobox) cannot reset the proxy. <br/>
Solution:
- Always close [NekoBox](https://github.com/cofedish/cofe-nekobox) normally.
- If you force quit by accident, open [NekoBox](https://github.com/cofedish/cofe-nekobox) again, enable `System proxy`, then disable it- this will reset the settings.

**Why [NekoBox](https://github.com/cofedish/cofe-nekobox) uses Noto emoji instead of Twitter emoji? What differences between them two?** <br/>
  ...
  Noto emoji provides better system integration and is part of the larger Noto fonts project, which aims to support all emoji characters defined in Unicode. Generally, Noto emoji are smaller than Twitter emoji. [NekoBox](https://github.com/cofedish/cofe-nekobox) does use Noto emoji font because we prefer better system integration over specific stylized design.
...
[![Star History Chart](https://api.star-history.com/svg?repos=cofedish/cofe-nekobox&type=Date)](https://www.star-history.com/#cofedish/cofe-nekobox&Date)
