...
namespace {
    ...
    QString BuildThemeQss(const ThemeTokens &t) {
        QString qss = QString(
                   ...
                   "QLineEdit#home_sub_url { background: %9; border: 1px solid %5; border-radius: 10px; padding: 6px 10px; }"
                   "QPushButton#home_sub_add { background: %9; border: 1px solid %5; border-radius: 10px; padding: 6px 12px; }"
