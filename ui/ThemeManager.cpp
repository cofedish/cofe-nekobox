...
namespace {
    ...
    QString BuildThemeQss(const ThemeTokens &t) {
        QString qss = QString(
                   ...
                   "QListWidget#drawer_nav::item { padding: 10px 14px; margin: 2px 0; min-height: 42px; border-radius: 12px; color: %6; font-size: 14px; }"
                   "QListWidget#drawer_nav::item:hover { background: %9; }"
                   "QListWidget#drawer_nav::item:pressed { background: %7; }"
                   "QListWidget#drawer_nav::item:selected { background: %7; color: %6; border-left: 3px solid %11; padding-left: 11px; font-weight: 600; }"
                   ...
                   "QComboBox QAbstractItemView { background: %4; border: 1px solid %5; border-radius: 10px; padding: 4px; selection-background-color: %11; selection-color: %12; }"
