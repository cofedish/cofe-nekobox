...
namespace {
    ...
    QString BuildThemeQss(const ThemeTokens &t) {
        QString qss = QString(
                   ...
                   "QToolButton#drawer_theme_button { background: %9; border: 1px solid %5; border-radius: 10px; padding: 6px 10px; min-height: 32px; font-size: 12px; font-weight: 600; }"
                   ...
                   "QToolButton#drawer_theme_button::menu-indicator { subcontrol-origin: padding; subcontrol-position: right center; width: 10px; }"
